...
import { client, keypair, IObjectInfo, getSgId } from "./utils.ts";
...
(async () => {
  ...
  try {
    ...
    fs.writeFileSync("./created_sg.json", JSON.stringify(objects, null, 2));
  } catch (e) {
    console.log(e);
  } finally {
    console.log("\n\nSuccessfully deployed at: " + getSgId("package"));
  }
})();
