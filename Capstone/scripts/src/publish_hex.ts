...
import { client, keypair, IObjectInfo, getHexId } from "./utils.ts";
...
(async () => {
  ...
  try {
    ...
    fs.writeFileSync("./created_hex.json", JSON.stringify(objects, null, 2));
  } catch (e) {
    console.log(e);
  } finally {
    console.log("\n\nSuccessfully deployed at: " + getHexId("package"));
  }
})();
