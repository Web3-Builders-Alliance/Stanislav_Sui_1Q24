...
import { client, keypair, IObjectInfo, getTicTacToeId } from "./utils.ts";
...
(async () => {
  ...
  try {
    ...
    fs.writeFileSync("./created_tic_tac_toe.json", JSON.stringify(objects, null, 2));
  } catch (e) {
    console.log(e);
  } finally {
    console.log("\n\nSuccessfully deployed at: " + getTicTacToeId("package"));
  }
})();
